            ...
            <div class="relative bg-white rounded-3xl shadow-sm overflow-hidden border border-gray-100 mb-8"> 
                ...
                <div class="relative p-6 md:px-12 md:py-8 flex flex-col md:flex-row items-center justify-between gap-4"> 
                    <div class="w-full md:w-3/5">
                        <h1 class="text-3xl font-bold text-[#4A6B2F] mb-2">Hai, {{ Auth::user()->name }}!</h1> 
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
        @php
            $alternativeActivities = [
                ['title' => 'Meditasi Pagi', 'category' => 'Relaksasi', 'icon' => 'mdi_meditation.svg'],
                ['title' => 'Stretching', 'category' => 'Olahraga', 'icon' => 'streching.png'],
                ['title' => 'Teh Pagi', 'category' => 'Ritual', 'icon' => 'streamline-flex_tea-cup-solid.svg'],
                ['title' => 'Jalan Kaki', 'category' => 'Olahraga', 'icon' => 'fa7-solid_walking.svg'],
                ['title' => 'Baca Buku', 'category' => 'Edukasi', 'icon' => 'ion_book.svg'],
            ];
        @endphp
        ...
        @foreach($alternativeActivities as $activity)
            <div class="bg-white rounded-[2rem] shadow-sm p-6 hover:shadow-lg transition-all duration-300 cursor-pointer border border-gray-50 flex flex-col items-center text-center group"
                ...
                <div class="w-20 h-20 rounded-2xl flex items-center justify-center mb-5 bg-green-50 group-hover:bg-green-100 transition-colors">
                    <img src="{{ asset('img/' . $activity['icon']) }}" 
                         alt="{{ $activity['title'] }}" 
                ...
                <button class="bg-[#72B940] hover:bg-[#558B2F] text-white text-xs font-bold py-2.5 px-4 rounded-xl w-full transition-all shadow-md shadow-green-100 active:scale-95 cornered-30">
                    Pilih
                </button>
            </div>
